...
var assignSample2SoundBuffer = function(decodedBuffer) {
        ...
        // var nowBuffering = soundBuffer.getChannelData(channel);
        // //console.log(nowBuffering.length);
        // return function(){
        //     for(var i=0;i<nowBuffering.length;i++){
        //         arr.push(nowBuffering[i]);
        //     }
        //     console.log(arr);
        // }
    }
...
function changeSample() {
    ...
    soundUrl = document.getElementById("sample_no").value; //复选框的值
...
$(document).ready(function() {
    ...
    // update sample list for selection 歌曲列表
    ...
    var $el = $("#sample_no");
    $el.empty(); // remove old options 清空选项
    //循环歌曲列表
